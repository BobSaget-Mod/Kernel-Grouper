...
int user_mv_table[MAX_DVFS_FREQS] = {
	800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225};
#endif
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("vde",    0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  426000,  426000,  426000,  426000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  426000,  426000,  426000,  426000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  426000,  426000,  426000,  426000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  426000,  426000,  426000,  426000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  426000,  426000,  426000,  426000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  426000,  426000,  426000,  426000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  426000,  426000,  426000,  426000),

	CORE_DVFS("vde",    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  426000,  426000,  426000,  426000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  426000,  426000,  426000,  426000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  426000,  426000,  426000,  426000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  426000,  426000,  426000,  426000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  426000,  426000,  426000,  426000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  426000,  426000,  426000,  426000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  426000,  426000,  426000,  426000),
	...
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  426000,  426000,  426000,  426000),
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  426000,  426000,  426000,  426000),
